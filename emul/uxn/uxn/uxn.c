...
static void op_dec(Uxn *u) { Uint8 a = pop8(u->src); push8(u->src, a - 1); }
...
static void op_dec16(Uxn *u) { Uint16 a = pop16(u->src); push16(u->src, a - 1); }
...
static void (*ops[])(Uxn *u) = {
	...
	op_add, op_sub, op_inc, op_dec, op_and, op_ora, op_eor, op_sft,
	/* 16-bit */
	...
	op_add16, op_sub16, op_inc16, op_dec16, op_and16, op_ora16, op_eor16, op_sft16
};
